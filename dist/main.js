...
function start(){
    ...
    if (localStorage.getItem('data') === null){
        ...
        for (let i = 0; i < dataStorage.length; i++){
            let tempProj = (0,_projectCreator__WEBPACK_IMPORTED_MODULE_1__["default"])(dataStorage[i].name);
    ...
    function taskFormFunction(task = undefined){
        ...
        document.querySelector(".new-task-form").addEventListener("submit", function(e){
            ...
            if (task === undefined){
                ...
                projectList[currentProject.dataset.id].addTask((0,_taskCreator__WEBPACK_IMPORTED_MODULE_0__["default"])(titleInput, descInput, dateInput, priorityInput));
            }
            else{
                task.title = titleInput;
                task.desc = descInput;
                task.priority = priorityInput;
                task.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dateInput, 'yyyy-MM-dd');
            }
            removeTaskForm();
            displayTasks();
        });
...
function createTask(title, desc, dueDate, priority) {
    ...
    const task = taskFactory(title, desc, (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(dueDate, 'yyyy-MM-dd'), priority);
    return task;
}
